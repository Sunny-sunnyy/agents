...
# Path configuration
TAI_LIEU_DIR = r"G:\Agent2026Win\agents\1_foundations\tai lieu"

def get_file_map():
    """
    Scans the target directory and maps lesson numbers to file paths.
    E.g., 10 -> 'G:\\...\\10. Day 2 - ... .txt'
    """
    file_map = {}
...
async def main():
    ...
    if not file_map:
        print("No lesson files found in G:\\Agent2026Win\\agents\\1_foundations\\tai lieu.")
        return
        
    # We want to process lessons 10 to 28
    lessons_to_process = [l for l in range(10, 29) if l in file_map]
